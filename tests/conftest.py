...
@pytest.fixture
def transactions_info() -> {list[dict[str, str | int] | dict[str, str | int]]}:
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
@pytest.fixture
def test_df_csv_xlsx():
    return {'id': 650703.0, 'state': 'EXECUTED', 'date': '2023-09-05T11:30:32Z', 'amount': 16210.0, 'currency_name': 'Sol',
         'currency_code': 'PEN', 'from': 'Счет 58803664561298323391', 'to': 'Счет 39745660563456619397',
         'description': 'Перевод организации'},{'id': 3598919.0, 'state': 'EXECUTED', 'date': '2020-12-06T23:00:58Z', 'amount': 29740.0,

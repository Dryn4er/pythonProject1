...
def main():
    ...
    if user_input_file == "1":
        ...
        transactions_from_file = get_transactions_data(
            "/Users/Admin/PycharmProjects/pythonProject1/data/operations.json"
        )
    elif user_input_file == "2":
        print("Для обработки выбран CSV-файл.")
        transactions_from_file = read_csv("../transactions.csv")
    elif user_input_file == "3":
        print("Для обработки выбран XLSX-файл.")
        transactions_from_file = read_xlsx("../transactions_excel (1).xlsx")
    else:
